...
description: A C++ implementation of the Boris Algorithm, which provide a very accurate trajectory even for very high $\gamma$ values
tags: physics simulation code
categories: research
